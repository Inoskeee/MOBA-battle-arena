<?php
	...
	$deleteboosterquery = "DELETE FROM character_booster WHERE character_booster.character_id = ".$existplayerid["character_id"]." LIMIT 1;";

	mysqli_query($connect, $deleteboosterquery) or die("5"); //: Insert player failed
